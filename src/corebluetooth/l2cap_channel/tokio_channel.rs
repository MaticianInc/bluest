...
use crate::{
    corebluetooth::types::{kCFStreamPropertySocketNativeHandle, CBL2CAPChannel, CFStream},
    error::ErrorKind,
    Error,
};
...
impl AsyncRead for TokioL2CapChannel {
...
impl AsyncWrite for TokioL2CapChannel {
...
impl Drop for TokioL2CapChannel {
    fn drop(&mut self) {
